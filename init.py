...
class SpecificGrandChild(Specific): pass
...
class F(Generic[T,U]): pass
class FL(F[str, V], Generic[V, W]): pass
class FR(F[X, int], Generic[Y, X]): pass
class FC(FL[int, Z], FR[Z, str]): pass
